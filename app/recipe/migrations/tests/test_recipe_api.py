...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_full_update(self):
        ...
        recipe = create_recipe(
            user=self.user,
            title='Sample title',
            link = 'htttps://example.com//recipe.pdf',
    ...
    def test_filter_by_tags(self):
        ...
        recipe1 = create_recipe(user=self.user, title='Chicken Tikka Masala')
        recipe2 = create_recipe(user=self.user, title='Butter Chicken')
    ...
    def test_filter_by_ingredients(self):
        """Filtering recipes by tags"""
        recipe1 = create_recipe(user=self.user, title='Enfrijoladas')
        recipe2 = create_recipe(user=self.user, title='Enchiladas')
        ingredient1 = Ingredient.objects.create(user=self.user, name='Beans')
        ingredient2 = Ingredient.objects.create(user=self.user, name='Tortillas')
        recipe1.ingredients.add(ingredient1)
        recipe2.ingredients.add(ingredient2)
        recipe3 = create_recipe(user=self.user, title='Chicken Nuggets')
...
class ImageUploadTest(TestCase):
    ...
    def tearDown(self):
        """Function to delete images we create for test"""
